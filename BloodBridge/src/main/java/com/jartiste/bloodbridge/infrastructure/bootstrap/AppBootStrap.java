...
import com.jartiste.bloodbridge.infrastructure.persistence.DonationRepoImpl;
...
public class AppBootStrap implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        try {
            ...
            DonationRepository donationRepo = new DonationRepoImpl(ds);


            // Init Services
            DonorService donorService = new DonorService(donorRepo, receiverRepo);
            ReceiverService receiverService = new ReceiverService(receiverRepo);
            DonationService donationService = new DonationService(donationRepo, donorRepo, receiverRepo);
            ...
            sce.getServletContext().setAttribute("DonationService", donationService);
